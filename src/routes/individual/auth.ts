...
import { authRequired, individualRequired, signToken, type UserRole } from '../../middleware/auth.js';
import { migrateIndividualRecords } from '../../services/individualPortalService.js';
...
router.get('/me', authRequired, individualRequired, async (req, res) => {
  try {
...
router.post('/change-password', authRequired, individualRequired, async (req, res) => {
  try {
